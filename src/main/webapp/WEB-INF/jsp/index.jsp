			...
			<img src="image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
							<c:forEach items="${hList }" var="product">
									<li>
										<a href="find_product_by_pid.do?pid=${product.pid }"><img src="${product.image }" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
									</li>
							</c:forEach>
						</ul>
...
<!-- 					<div class="newProductAd">
						 ...
						 <ul class="tabContent" style="display: block;">
								<c:forEach items="${nList }" var="product">
									<li>
										<a  target="_blank"  href="find_product_by_pid.do?pid="+${product.pid }><img src="${product.image }" data-original="http://storage.shopxx.net/demo-image/3.0/201301/b499fb5e-999f-431b-a375-172ee09e4a3e-thumbnail.jpg" style="display: block;" /></a>
									</li>
								</c:forEach>
						</ul>
						<ul class="tabContent" style="display: none;">
