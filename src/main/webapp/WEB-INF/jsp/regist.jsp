...
<script type="text/javascript">
	...
	function checkUsername(){
		var username = $("#username").val();
		$.get("find_by_username.do",{"username":username},function(data){
			$("#span1").text(data.msg);
		});
	}
	//点击改变验证码
	function change(){
		$("#captchaImage").attr("src","get_vCode.do?"+new Date().getTime());
	}
</script>
</head>
<body>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="insert_user.do" method="post" novalidate="novalidate" onsubmit="return checkForm();" >
						<table>
							<tbody><tr>
								<th>
								...
								<td>
									...
									<span id="span1" style="color: red">${username }</span>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									...
									<span id="span4" style="color: red">${email }</span>
								</td>
							</tr>
									<tr>
										<th>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="vCode" class="text captcha" maxlength="4" autocomplete="off">
											<img id="captchaImage" class="captchaImage" src="get_vCode.do" title="点击更换验证码" onclick="change()">
										</span>
									</td>
								</tr>
							<tr>
